    ...
    <>
      ...
      <div style={{ maxWidth: 'var(--max-width)', margin: '0 auto', padding: '0 var(--pad-l) 3rem' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', margin: '2rem 0' }}>
          <img src="/sanctuary-react/container/18a8b01a-c614-4c00-8fb9-848f7707cd0a_960x939.jpg" alt="Container experience" style={{ width: '100%', borderRadius: '8px' }} />
          <img src="/sanctuary-react/container/1c9ac1fb-b6f0-4842-acff-5467d81a132e_1280x1002.webp" alt="Container experience" style={{ width: '100%', borderRadius: '8px' }} />
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', margin: '1rem 0 2rem' }}>
          <img src="/sanctuary-react/container/photo_2026-03-21_18-02-48.jpg" alt="Container experience" style={{ width: '100%', borderRadius: '8px' }} />
          <img src="/sanctuary-react/container/e051fbad-12bb-43b1-8013-5024bc5fa01f_1600x1200.webp" alt="Container experience" style={{ width: '100%', borderRadius: '8px' }} />
        </div>
      </div>
      ...
      <div style={{ maxWidth: 'var(--max-width)', margin: '0 auto', padding: '0 var(--pad-l) 3rem' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', margin: '2rem 0' }}>
          <img src="/sanctuary-react/container/ce9c1205-9452-41ab-b30a-08ac8fbef564_1612x802.webp" alt="Technology work" style={{ width: '100%', borderRadius: '8px' }} />
          <img src="/sanctuary-react/container/0415431b-c3f2-4d72-a07e-4a88f89e9018_1280x960.webp" alt="Technology work" style={{ width: '100%', borderRadius: '8px' }} />
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', margin: '1rem 0 2rem' }}>
          <img src="/sanctuary-react/container/fe959501-8142-452a-b3bc-e8f14b3c1db1_1600x1204.webp" alt="Technology work" style={{ width: '100%', borderRadius: '8px' }} />
          <img src="/sanctuary-react/container/2647c2b2-6c99-4c2e-a7a7-6aae15d55632_1622x1218.webp" alt="Technology work" style={{ width: '100%', borderRadius: '8px' }} />
        </div>
      </div>
      ...
      <div style={{ maxWidth: 'var(--max-width)', margin: '0 auto', padding: '0 var(--pad-l) 3rem' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', margin: '2rem 0' }}>
          <img src="/sanctuary-react/container/c9b3d69f-eb41-49df-9114-6b617c0cfd06_1600x1200.webp" alt="Community space" style={{ width: '100%', borderRadius: '8px' }} />
          <img src="/sanctuary-react/container/588c6c06-ac25-493c-9bc6-d7580de76894_1622x1218.webp" alt="Community space" style={{ width: '100%', borderRadius: '8px' }} />
        </div>
      </div>
